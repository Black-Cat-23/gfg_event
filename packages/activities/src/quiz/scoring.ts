import { QuizConfig, QuizQuestion } from '@recruitquest/types';

export function calculateQuizQuestionScore(
  question: QuizQuestion,
  submissionAnswer: number | string | undefined,
  responseTimeMs: number,
  scoringConfig: QuizConfig['scoring']
): number {
